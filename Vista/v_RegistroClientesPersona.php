...
<html>
    ...
    <!-- JS -->
    <script type="text/javascript" src="js/registroClienteParticular.js"></script>
    ...
    <body>
        <form action="s_RegistroClientesPersona.php" method="POST">
            ...
            <div class="container col-12" style="width: 100%;  height: 100%;  overflow: auto;  margin: auto; position: absolute; top: 180px; left: 0; bottom: 0; right: 0;">
                <br>
                <div class="row ">
                    <div class="col-6">
                        <img src="img/pic2.jpg" alt="pic1">
                    </div>
                    <div class="col-6 justify-content-end" style="padding-right: 10%">
                        <div class="card" style="border: 0px;">
                            ...
                            <div class="card-body">
                                <div class="title h5 text-center text-muted">Cliente Particular</div>
                                <hr>
                                <div class="row">
                                    <div class="col-6"  style="font-family: 'Varela Round', sans-serif; font-size: 18px">Rut</div>
                                    <div class="col-6"><input type="text" id="txtRut" name="txtRut" class="form-control h-75 border-info" value="" onkeyup="checkRut()" required /></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6"><input type="password" id="txtPass" name="txtPass" class="form-control h-75 border-info" value="" onkeyup="check()" required/></div>
                                </div>  
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6" style="font-family: 'Varela Round', sans-serif; font-size: 18px">Correo</div>
                                    <div class="col-6"><input type="text" name="txtEmail" class="form-control h-75 border-info" value="" required/></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6"><input type="text" name="txtDireccion" class="form-control h-75 border-info" value="" required/></div>
                                </div>
                            </div>
